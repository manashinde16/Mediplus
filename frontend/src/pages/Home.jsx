          ...
          <div className='lg:w-[570px]'>
             <h1 className='text-[36px] leading-[46px] text-headingColor font-[800] md:text-[60px] md:leading-[70px]'>
               ...
               <p className='text__para'>
                 “In order to be a good doctor, a man must have a good character. 
                  Whatever weaknesses and foibles he may have, he must overcome his fellow 
                  human beings in the concrete and desire his good before his own.”
                </p>
  ...
  <section>
    <div className="container">
          ...
          <ul className='pl-4'>
            ...
            <li className='text__para'>
               <p>3. View Our Physicians who are accepting new patients, </p>
                 <p>use the online scheduling tool to select an appointment time.</p>
            </li>
          </ul>
          <Link to="/">
      ...
      <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0'>
        ...
        <div className='w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lg:py-[6px] lg:px-[10px] text-[8px] leading-[8px] lg:text-[12px] lg:leading-4 text-irisBlueColor font-[1000] mt-2 lg:mt-4 rounded-full'>
          Consultation
          </div> 
